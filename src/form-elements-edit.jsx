    ...
    return (
      <div>
        ...
        {this.props.element.hasOwnProperty('label') && (
          <div className="form-group">
            {this.props.element.element !== 'Recaptcha' && (
              <>
                <label>
            ...
            {BookitupUtils.showRequiredCheckbox(this.props.element) &&
        ...
        {this.props.element.hasOwnProperty('sitekey') && (
          <div>
            <br/>
            <div className="form-group">
              <label className="control-label" htmlFor="sitekeyInput">
                Site key:
              </label>
              <input
                id="sitekeyInput"
                type="text"
                className="form-control"
                defaultValue={this.props.element.sitekey}
                onBlur={this.updateElement.bind(this)}
                onChange={this.editElementProp.bind(this, 'sitekey', 'value')}
              />
            </div>
          </div>
        )}
        {this.props.element.hasOwnProperty('gdprLink') && !this.props.element.hasOwnProperty('statement') && (
          <div>
            <br/>
            <div className="form-group">
              <label className="control-label" htmlFor="gdprLinkInput">
              ...
              <input
                ...
                onBlur={this.updateElement.bind(this)}
                onChange={this.editElementProp.bind(this, 'gdprLink', 'value')}
              />
            </div>
          </div>
        )}
